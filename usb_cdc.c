...
static void reset_usb(void) {
	...
	/*
	 * Hacky USB reset (without external hardware), copied from
	 * STM32duino-bootloader, Credit goes to @Victor_pv apparently
	 * who came up with the idea of just driving the pin low instead
	 * of pulling low with an external transistor.
	 */
